...
#ifndef GOOGLE_PROTOBUF_INCLUDED_serverstreaming_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_serverstreaming_2eproto
...
struct TableStruct_serverstreaming_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_serverstreaming_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::serverstreaming::Message* Arena::CreateMaybeMessage<::serverstreaming::Message>(Arena*);
template<> ::serverstreaming::Number* Arena::CreateMaybeMessage<::serverstreaming::Number>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace serverstreaming {
...
class Message final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:serverstreaming.Message) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "serverstreaming.Message";
  }
  protected:
 ...
 private:
  ...
  friend struct ::TableStruct_serverstreaming_2eproto;
};
// -------------------------------------------------------------------

class Number final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:serverstreaming.Number) */ {
 public:
...
inline const std::string& Message::message() const {
  // @@protoc_insertion_point(field_get:serverstreaming.Message.message)
...
void Message::set_message(ArgT0&& arg0, ArgT... args) {
 ...
 message_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:serverstreaming.Message.message)
}
inline std::string* Message::mutable_message() {
  std::string* _s = _internal_mutable_message();
  // @@protoc_insertion_point(field_mutable:serverstreaming.Message.message)
  return _s;
}
...
inline std::string* Message::release_message() {
  // @@protoc_insertion_point(field_release:serverstreaming.Message.message)
...
inline void Message::set_allocated_message(std::string* message) {
  ...
  // @@protoc_insertion_point(field_set_allocated:serverstreaming.Message.message)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Number::value() const {
  // @@protoc_insertion_point(field_get:serverstreaming.Number.value)
...
inline void Number::set_value(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:serverstreaming.Number.value)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_serverstreaming_2eproto
