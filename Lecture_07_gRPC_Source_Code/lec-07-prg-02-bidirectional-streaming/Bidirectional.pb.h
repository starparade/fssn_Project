...
PROTOBUF_NAMESPACE_OPEN
template<> ::bidirectional::Message* Arena::CreateMaybeMessage<::bidirectional::Message>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace bidirectional {
...
class Message final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:bidirectional.Message) */ {
 public:
...
inline const std::string& Message::message() const {
  // @@protoc_insertion_point(field_get:bidirectional.Message.message)
...
void Message::set_message(ArgT0&& arg0, ArgT... args) {
 ...
 message_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:bidirectional.Message.message)
}
inline std::string* Message::mutable_message() {
  std::string* _s = _internal_mutable_message();
  // @@protoc_insertion_point(field_mutable:bidirectional.Message.message)
  return _s;
}
...
inline std::string* Message::release_message() {
  // @@protoc_insertion_point(field_release:bidirectional.Message.message)
...
inline void Message::set_allocated_message(std::string* message) {
  ...
  // @@protoc_insertion_point(field_set_allocated:bidirectional.Message.message)
}
